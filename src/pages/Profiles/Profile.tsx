                    ...
                    <div>
                        <form onSubmit={(e) => handlerNewPassword(e)}>
                            <div className="principal">
                                ...
                                <input placeholder='Digite aqui a sua nova senha' onChange={(e) => setSenha(e.target.value)} />
                                <span>Confirmação de senha:</span>
                                <input placeholder='Digite novamente a sua senha nova' onChange={(e) => setConfirmarSenha(e.target.value)} />
                            </div>
                            <div className='botao'>
